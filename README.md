...
Common tools and packages used in pipelines managing kubernetes on EKS. Works in conjunction with the [twdps/kube-ops](https://github.com/twplatformlabs/orb-kube-ops) orb.  
...
```
twdps/circleci-eks-ops:-<YYYY.MM>
twdps/circleci-eks-ops:-stable
twdps/circleci-eks-ops:-edge
```
